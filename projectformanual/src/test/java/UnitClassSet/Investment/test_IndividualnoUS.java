...
public class test_IndividualnoUS extends SetupClass {
    private String individual_noUS = "prybehav+155@gmail.com";

    @Title("Test Individual no US investment process for ACH method")
    @Severity(SeverityLevel.CRITICAL)
    @Features({"Investment","Individual no US","ACH"})
    ...
    @Title("Test Individual no US investment process for Wire method")
    @Severity(SeverityLevel.CRITICAL)
    @Features({"Investment","Individual no US","Wire"})
    ...
    @Title("Test Individual no US investment process for Bitcoin method")
    @Severity(SeverityLevel.CRITICAL)
    @Features({"Investment","Individual no US","Bitcoin"})
    ...
    @Title("Test Individual no US investment process for Ethereum method")
    @Severity(SeverityLevel.CRITICAL)
    @Features({"Investment","Individual no US","Ethereum"})
